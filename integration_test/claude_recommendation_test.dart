...
/// E2E tests for Claude recommendations: navigate to home feed,
/// verify AI recommendation cards or recommendation UI. Used by CI for critical user flow validation.
void main() {
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();

  group('Claude Recommendation E2E', () {
