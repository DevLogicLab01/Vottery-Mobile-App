...
/// E2E tests for vote casting: navigate to election, select option, submit vote,
/// verify VP or ticket notification. Used by CI for critical user flow validation.
void main() {
  ...
  group('Vote Casting E2E', () {
    testWidgets('User can cast vote in election', (tester) async {
      ...
      expect(
        successMessage.evaluate().isNotEmpty || ticketPopup.evaluate().isNotEmpty,
        isTrue,
