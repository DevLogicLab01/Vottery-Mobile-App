...
class AlertCategoryFilterWidget extends StatelessWidget {
  final Set<String> activeFilters;
  final Map<String, int> unreadCounts;
  final Function(Set<String>) onFilterChanged;
  final Function(String) onSelectCategory;

  const AlertCategoryFilterWidget({
    super.key,
  ...
  final Map<String, Map<String, dynamic>> _categories = const {
    ...
    'system': {'label': 'System', 'icon': Icons.settings, 'color': Colors.grey},
  };
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              title: Text(
                'Select all ${_categories[category]!['label']} alerts',
              ),
              onTap: () {
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final unreadCount = unreadCounts[category] ?? 0;
